...
(`user_id`,
 ...
 `regDate`)
  VALUES
  (1, NULL, 'user_1@ema.il', 'user_1', '$2a$10$ixBcFR7yoCUZwh7ZTiUmhuYITcSdxRdZVLDHXuF2AC8ZGLJpaD8ru', now()),
  (2, NULL, 'user_2@ema.il', 'user_2', '$2a$10$2j0cFKTL48ANcCDObzZPxuNWZMF8Wf68eYOWb9iOa7TgapXgm/eJK', now()),
  (3, NULL, 'user_3@ema.il', 'user_3', '$2a$10$botQylKH/fnR2YqlT.jhpeoPicl4xuucgN7R41bcQz9NAqP3kTDRq', now());
-- Password is bcrypt of username (ex. 'user_1')
...
INSERT INTO `ugly_blog_db`.`user_role`
(`user_id`,
 `role_id`)
  VALUES
  (1, 1),
